...
public class SingletonMemories {
    private String memoTitle;
    private String memoNumOfComment;
    private String memoNumOfShare;
    private int memoThumbnail;

    public SingletonMemories() {
    }

    public SingletonMemories(String memoTitle, String memoNumOfComment, String memoNumOfShare, int memoThumbnail) {
